...
def compute_regression_metric( 
    ...
    # print(prob.shape)
    # sys.exit()
    # print(prob[0,0,0:101])
    # print(prob[0,0,101:202])

    # prob_indices_0 = prob[0,0,0:101]
    # prob_indices_1 = prob[0,0,101:202]



    # ranked_prob_indices_0 = torch.argsort(
    #     prob[0,0,0:101], dim=-1, descending=True
    # )

    # ranked_prob_indices_1 = torch.argsort(
    #     prob[0,0,101:202], dim=-1, descending=True
    # )

    # print(ranked_prob_indices_0)
    # print(ranked_prob_indices_1)

    # # plt.plot(ranked_prob_indices_0.cpu().numpy())
    # # plt.plot(ranked_prob_indices_1.cpu().numpy())

    # plt.plot(prob_indices_0.cpu().numpy())
    # plt.plot(prob_indices_1.cpu().numpy())
    # plt.savefig("prob")

    # # print(torch.sum(prob[0,0,:]))
    # sys.exit()
    ...
    # prompt_values = [15,35,45,55,65,85]
    prompt_values = [15,37,50,62,85]

    prompt_values = torch.tensor(prompt_values).to(logits.device)

    # constant = torch.tensor([[0.285],[0.713],[1],[1.188],[1.616]]).cuda()

    # constant = constant.reshape(1,-1)

    # prompt_values = prompt_values * constant

    
    # # print(prompt_values)
    # # sys.exit()
    # prompt_values = torch.tensor(prompt_values).to(logits.device)
    # # print(prompt_values.shape)
    # # sys.exit()

    pred_frame = prob * prompt_values
    
    # per frame calculation way
    # pred_frame = torch.sum(pred_frame,dim=-1)
    # pred_video = torch.mean(pred_frame,dim=-1)


    # because already fuse the frame feature, so only calcuate the sum to get the final prediction. 
...
# ----------------------------------------------zero-shot prediction--------------------
    ...
    # # print(torch.sum(per_frame_similarities[0,0,:]))

    # # print(per_frame_similarities.shape)
    # # [10,16,202]
    # # sys.exit()
    ...
    # )
    # # print(ranked_candidate_phrase_indices.shape)
    # # [10,16,202]
    # # sys.exit()
    ...
    # # print(all_frames_ranked_values.shape)
    # # [10,16,202]
    # # sys.exit()
    ...
    #     dim=1
    # )  # (N x Candidates)
    # # print(avg_frame_ranked_values.shape)
    # # [10,202]
    # # sys.exit()
...
def compute_regression_metric_mean_std( 
    video_embeddings: torch.Tensor,
    prompt_embeddings: torch.Tensor,
    logits: torch.Tensor,
    mean: torch.Tensor,
    ...
    # sys.exit()
    prompt_values = prompt_values * mean + std
    prompt_values = prompt_values.squeeze(0)
    # print(prompt_values)
    # sys.exit()
    # print(prompt_values.shape)
    # sys.exit()
...
def compute_regression_prediction(
    ...
    # print(per_frame_similarities[0,1,:])
